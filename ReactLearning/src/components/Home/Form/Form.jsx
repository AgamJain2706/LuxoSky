      ...
      <div className='Box shadow-2xl  '>
        <div className='my-8 p-4 '>
          ...
          <div className='lg:flex flex-col md:flex-row justify-between pt-4 p-4 box-border w-full'>
            <span className='text-xl bg-[#0b2545] text-white font-semibold w-full lg:w-3/5 h-10 flex items-center pl-3'>
          ...
          <div className='grid lg:grid-rows-2  md:grid-rows-2  grid-cols-1  justify-between   '>
            <form action="#">
              <div>
                <input type="text" placeholder='First Name* ' className='rounded-md pl-2 mb-2  ' />
                <input type="text" placeholder='Last Name* ' className='rounded-md pl-2  mb-2 ' />
                <input type="text" placeholder='Company* ' className='rounded-md pl-2    mb-2  ' />
              </div>
              <div className='input-box   '>
                ...
                <input type="text" placeholder='Phone Number*' className='rounded-md pl-2 mb-2 ' />
                <input type="text" placeholder='Email Id  ' className='rounded-md pl-2  mb-2 '/>
              </div>
            </form>
            <div className='flex flex-col md:flex-row  pt-4 px-4 box-border w-full'>
              <span className='text-xl bg-[#0b2545] text-white font-semibold w-full md:w-2/5 lg:w-3/5 h-10 flex items-center pl-3'>
                FLIGHTS INFORMATION
              </span>
            ...
            <section className='sections'>
              <form action="#">
                <div id='Form_input' className='Form_input'>
                  <input type="text" placeholder='Departure City* ' className='rounded-md pl-2 mb-2 ' />
                  <input type="text" placeholder='Departure Date  ' className='rounded-md pl-2 mb-2 ' />
                ...
                {!isOneWay && (
                  <div className='input-box   '>
                    <input type="text" placeholder='Arrival City* ' className='rounded-md pl-2 mb-2 ' />
                    <input type="text" placeholder='Arrival Date  ' className='rounded-md pl-2 mb-2  ' />
                    <select id="returnTime" className='text-black' >
          ...
          <section className='mt-8 '>
            <form action="/">
              <select id="returnTime" className='text-black mb-2'>
              ...
              <select name="Aircraft" id="" className='mb-2'>
              ...
              <select name="travel" id="" className='mb-2'>
